(function ($) {
    ...
    $(window).on('load', function () {
        ...
        function create_report_cell(row_index, column_name, data) {
            let report = data[row_index]['Bericht'];

            let td = document.createElement('td');
            let textNode = document.createTextNode(data[row_index][column_name]);
            let link = document.createElement('a');
            link.appendChild(textNode);
            link.title = data[row_index][column_name];
            link.href = report
        ...
        function read_sheets_calendar(data) {
            ...
            for (let row_index in calendar) {
                ...
                if (calendar[row_index]['Bericht'] !== '') {
                    tr.appendChild(create_report_cell(row_index, 'Was', calendar));
                } else {
